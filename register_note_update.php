		...
		<form action="actualizar.php" method="post" >
			...
			<table id="i1" class="ibox">
				<td class="input" width="*">
					<input type="text" name="titulo" id="title" placeholder="Titulo" maxlength="160" required="" value="<?php echo $titulo?>">
				</td>
			</table>
			<table id="i2" class="ibox">
					<input type="date" name="fecha" placeholder="fecha" required="" value="<?php echo $fecha?>">
			</table>
			<textarea  maxlength="15000"  name="contenido" placeholder="Que paso hoy?" required=""><?php echo $contenido?></textarea>
